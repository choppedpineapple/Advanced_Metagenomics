...
#msub_no_stop_codons = merged_subset.filter((pl.col("stop_codon_heavy")=="F") & (pl.col("stop_codon_light")=="F"))
...
rows_with_empty = len(msub_sc_2_clean.rows())
rows_without_empty = len(msub_null_clean.rows())
...
all_hcdr3s = msub_null_clean["cdr3_aa_heavy"].value_counts(sort=True)
